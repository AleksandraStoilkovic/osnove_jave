...
//		Objasnjenje v6tuOipj5mk je id videa.
	...
	public void pojacaj() {
		...
		this.jacinaZvuka+=10;
	} else if(this.jacinaZvuka>90 && this.jacinaZvuka<100) {
	...
	public void smanji() {
		...
		this.jacinaZvuka-=10;
	}  else if(this.jacinaZvuka>0 && this.jacinaZvuka<10) {
		this.jacinaZvuka = 0;
		}
}
	...
	public void premotajUnapred() {
		...
		this.trenutnoVreme=this.video.getDuzina();
	}
	}
	public void premotajUnazad(){
		if(this.video.getDuzina() >= 10) {
		this.trenutnoVreme-=10;
	} else {
		this.trenutnoVreme=0;
	}
	...
	public void iscrtajZvuk() {
		...
		if(this.rezim.equals("mini player")) {
			System.out.println("[ ]");
		}else if(this.rezim.equals("bioksopski")) {
			System.out.println("[ ..]");
