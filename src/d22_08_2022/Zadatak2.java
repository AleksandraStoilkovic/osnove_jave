...
//		   Ukupno: (ukupna cena) 	
		...
		Proizvod kafa = new Proizvod("74654676-8574765", "C kafa", 1000);
		System.out.println("Cena za 1 kg proizvoda iznosi: " + kafa.getCenaKg() + " dinara, a cena za jednu funtu iznosi: "
		+ kafa.getCenaLb() + " dinara.");
		kafa.print();
		Vaga vaga = new Vaga();
		vaga.setMernaJedinica("lb");
		vaga.setProizvod(kafa);
		vaga.print(3);
	}
