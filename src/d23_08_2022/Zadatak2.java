...
//				Naravno u glavnom kreirati objekte i testirati funkcionalnosti 
		...
		Racun salje = new Racun("451-5645665-4646", "Arsenije Simonovic", 72500);
		Racun prima = new Racun ("666-576755-765", "Aleksandra Stoilkovic", 103000);
		Transakcija prva = new Transakcija("78645443", salje, prima);
		prva.izvrsiTransakciju(12000);
		salje.print();
		prima.print();
		prva.print();
